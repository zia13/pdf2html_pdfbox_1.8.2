...
public class PDFTextStripperByArea extends PDFTextStripper
{
    ...
    public Map<String,Vector<ArrayList<TextPosition>>> regionCharacterList = 
    ...
    public File file = new File("D:/regionextract.txt");
//    public BufferedWriter outtputt = new BufferedWriter(new FileWriter(file));
    /**
     * Constructor.
    ...
    public PDFTextStripperByArea(int toClearLine) throws IOException
    {
        super(toClearLine);
        setPageSeparator( "" );
    }
